...
public final class Steambird: Sendable {
  ...
  public func fetchByIssuer(issuer: String, since: String? = nil, until: String? = nil) async throws
    -> [Notification]
  {
    ...
    let wrapped: Notifications = try await client.get(
      endpoint: "/steambird/v1/notifications", parameters: parameters)
