...
public final class OAuth: Sendable {
  ...
  public func getAccessTokenByCode(using code: String, redirectUri: String, pkce: PKCE) async throws
    -> Token
  {
  ...
  public func getAuthorizeURL(
    callback _: ASWebAuthenticationSession.Callback, redirectUri: String, pkce: PKCE, state: String
  ) throws -> URL {
  ...
  public func getAuthorizationCode(
    from url: URL, expectedState: String, expectedRedirectUri: String
  ) throws -> String {
    try verifyAuthorizationResponse(
      url: url, expectedState: expectedState, expectedRedirectUri: expectedRedirectUri)
  ...
  private func verifyAuthorizationResponse(
    url: URL, expectedState: String, expectedRedirectUri: String
  ) throws {
