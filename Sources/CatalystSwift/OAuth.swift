...
public final class OAuth {
    ...
    internal init(client: CatalystSwift) {
        self.client = client
    }
    ...
    public func getAuthorizeURL(callback: ASWebAuthenticationSession.Callback, redirectUri: String, pkce: PKCE, state: String) throws -> URL {
        var components = URLComponents(string: PUBLIC_AUTHORIZE_ENDPOINT)!
        components.queryItems = [
            URLQueryItem(name: "response_type", value: "code"),
            URLQueryItem(name: "client_id", value: self.client.clientId),
